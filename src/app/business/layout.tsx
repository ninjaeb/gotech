...
// search, no notifications, none of the CRM's nav. Same minimal header
// approach as the client portal (src/app/portal).
      ...
      <header className="border-b border-slate-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
        <div className="flex w-full items-center gap-3 px-4 py-3 sm:px-8">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold text-slate-900 dark:text-slate-100">Gotka business portal</p>
