...
export default async function ContactDetailPage({
  ...
  return (
    <div>
      <PageHeader
        breadcrumbs={[{ label: "Contacts", href: "/system/contacts" }, { label: contactName }]}
        title={contactName}
        description={
        ...
        actions={
          <>
            ...
            <Link
              href={`/system/contacts/${contact.id}/edit`}
            ...
            <CardBody>
              <div className="flex items-center gap-4 pb-4">
                ...
                <div>
                  ...
                  {contact.company && (
                    <Link
                      href={`/system/companies/${contact.company.id}`}
                      ...
                      <span className="flex min-w-0 items-center gap-1.5">
                        ...
                        {hasWhatsAppAccount && (
                          <>
                            ...
                            <Link
                              href={`/system/whatsapp/${contact.id}`}
          ...
          deals: (
            <Card>
              <CardHeader>
                ...
                <Link
                  href={`/system/deals/new?contactId=${contact.id}`}
