  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Link href="/system/settings/referrals" className={buttonClasses("secondary", "sm")}>
                ...
                <li key={commission.id} className="flex flex-wrap items-center justify-between gap-2 py-2.5 text-sm">
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-xs text-slate-400">
                      ...
                      {commission.dealId ? (
                        <Link href={`/system/deals/${commission.dealId}`} className="text-indigo-600 hover:underline dark:text-indigo-400">
        ...
        <CardBody>
          {partnerRows.length === 0 ? (
            <EmptyState
              ...
              action={
                <Link href="/system/settings/team" className={buttonClasses("primary", "sm")}>
                  Go to Team
                </Link>
              }
            />
