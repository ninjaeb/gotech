...
export default async function CompanyDetailPage({
  ...
  return (
    <div>
      <PageHeader
        breadcrumbs={[{ label: "Companies", href: "/system/companies" }, { label: company.name }]}
        title={company.name}
        ...
        actions={
          <>
            <Link
              href={`/system/companies/${company.id}/edit`}
          ...
          contacts: (
            <Card>
              <CardHeader>
                ...
                <Link
                  href={`/system/contacts/new?companyId=${company.id}`}
          ...
          deals: (
            <Card>
              <CardHeader>
                ...
                <Link
                  href={`/system/deals/new?companyId=${company.id}`}
                  className={buttonClasses("secondary", "sm")}
                >
                  <Plus className="h-4 w-4" />
                  Add deal
