...
export default async function ReferralSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        breadcrumbs={[{ label: "Settings", href: "/system/settings" }, { label: "Referrals" }]}
        title="Referrals"
        ...
        <CardBody>
          <ol className="list-decimal space-y-2 pl-5 text-sm text-slate-600 dark:text-slate-300">
            ...
            <li>
              ...
              <Link href="/system/referrals" className="text-indigo-600 hover:underline dark:text-indigo-400">
                Referrals
              </Link>{" "}
