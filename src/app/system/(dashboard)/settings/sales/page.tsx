...
export default async function SalesSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        breadcrumbs={[{ label: "Settings", href: "/system/settings" }, { label: "Sales" }]}
        title="Sales"
        description="Pipelines, catalog, and quoting"
      />
      <SettingsLinkCard
        href="/system/settings/pipelines"
        title="Pipelines"
