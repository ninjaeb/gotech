...
// Business portal counterpart to the system CRM's ImportForm
// (src/components/contacts/import-form.tsx) — same upload → preview →
// confirm flow, wired to the partner-scoped preview/confirm actions.
type Phase =
  | { name: "upload" }
